...
export default function CadastroProdutos() {
    ...
    return (
        <main className="grow p-5">
            ...
            <form onSubmit={handleSubmit} className="w-1/3 m-auto p-2 border border-indigo-950 rounded-md">
                ...
                <button className="rounded-md bg-green-700 text-white text-xl p-2 block ms-auto me-2" type='submit'>Cadastrar Produto</button>
            </form>
        </main>
    )
}